...
import { Send, User, ChevronLeft, ThumbsUp } from "lucide-react";
...
> = {
  1: {
    ...
    content:
      "I am struggling with the implementation of BST insert method. Can you help explain the recursive approach? I have tried several times but keep getting errors.",
    ...
    answers: [
      ...
      },
      {
        ...
        content:
          "Great question! I found this video helpful: [link]. The key is understanding the base case.",
        time: "30 minutes ago",
        likes: 2,
      },
    ],
    ...
    answers: [
      {
        ...
        content:
          "Memoization is top-down (recursive with caching), while tabulation is bottom-up (iterative with table). Both solve overlapping subproblems but use different approaches.",
        time: "3 hours ago",
        likes: 8,
        isTutor: false,
      },
...
export function QuestionDetailScreen({ isTutor }: QuestionDetailScreenProps) {
  ...
  const t = {
    ...
    noAnswers:
      language === "en"
        ...
        : "Chưa có câu trả lời. Hãy là người đầu tiên trả lời!",
    success:
      language === "en"
  ...
  const question =
    mockQuestionDetails[questionId as keyof typeof mockQuestionDetails];
