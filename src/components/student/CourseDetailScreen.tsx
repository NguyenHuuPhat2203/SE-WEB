...
export function CourseDetailScreen({}: CourseDetailScreenProps) {
  ...
  const t = {
    ...
    courseDescription:
      language === "en" ? "Course description" : "Mô tả môn học",
  ...
  const course = {
    ...
    outcomes: [
      language === "en"
        ...
        : "Hiểu các khái niệm và thuật toán học máy cốt lõi",
      language === "en"
        ? "Implement ML models using popular frameworks"
        : "Triển khai mô hình ML sử dụng các framework phổ biến",
      language === "en"
        ? "Evaluate and optimize model performance"
        : "Đánh giá và tối ưu hóa hiệu suất mô hình",
      language === "en"
        ? "Apply ML techniques to real-world problems"
        : "Áp dụng kỹ thuật ML vào các vấn đề thực tế",
    ],
  };
  ...
  const syllabus = [
    ...
    },
    {
      ...
      activities:
        language === "en" ? "Lab session, Quiz 1" : "Thực hành, Kiểm tra 1",
    },
    {
      week: 4,
      topic:
      ...
      activities:
        language === "en"
          ? "Lab session, Problem set 2"
          : "Thực hành, Bài tập 2",
    },
    {
      week: 5,
      topic:
        language === "en" ? "Support Vector Machines" : "Máy vector hỗ trợ",
      activities:
        language === "en"
          ? "Lab session, Project proposal due"
          : "Thực hành, Nộp đề xuất dự án",
    },
    {
      week: 6,
      topic:
        language === "en" ? "Neural Networks Basics" : "Cơ bản về Mạng nơ-ron",
      activities:
        language === "en" ? "Lab session, Quiz 2" : "Thực hành, Kiểm tra 2",
    },
    {
      week: 7,
          ...
          <TabsContent value="syllabus" className="space-y-6">
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  {course.duration} week curriculum with lectures, labs, and
                  assessments
                </CardDescription>
              </CardHeader>
              <CardContent>
