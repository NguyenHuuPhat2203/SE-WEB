...
export function QAScreen() {
  ...
  const t = {
    ...
    questionContent:
      language === "en" ? "Question Content" : "Nội dung câu hỏi",
    ...
    successQuestion:
      language === "en" ? "Question posted successfully!" : "Đã đăng câu hỏi!",
  ...
  const handlePostQuestion = async () => {
    ...
    try {
      const newQuestion = await api.post("/addquestion", {
  ...
  const handlePostAnswer = async () => {
    if (!selectedQuestionId || !newAnswerContent.trim()) return;

    try {
      const result = await api.post(
        `/questions/${selectedQuestionId}/answers`,
        {
      ...
      <div className="mb-6 flex items-center justify-between">
        ...
        >
          <DialogTrigger asChild>
            <Button>
              <Plus className="h-4 w-4 mr-2" /> {t.newQuestion}
            </Button>
          </DialogTrigger>
          ...
          <DialogContent className="sm:max-w-[600px]">
            ...
            <div className="space-y-4 py-4">
              <div className="space-y-2">
                ...
                <Select
                  ...
                  onValueChange={setNewQuestionTopic}
                >
                  <SelectTrigger>
            ...
            <DialogFooter>
              <Button
                variant="outline"
                onClick={() => setNewQuestionDialogOpen(false)}
              >
                {t.cancel}
              </Button>
