...
export function ResourceLibraryScreen({}: ResourceScreenProps) {
  ...
  const t = {
    ...
    description:
      language === "en"
        ? "Access lecture notes, videos, and study materials"
        : "Truy cập ghi chú bài giảng, video và tài liệu học tập",
  ...
  const resources = [
    {
      ...
      size: "2.4 MB",
      description:
        "Comprehensive lecture notes covering fundamental data structures including arrays, linked lists, stacks, queues, and trees. Includes examples and practice problems.",
      content: "This document contains detailed notes from weeks 1-5...",
    ...
    },
    {
      ...
      duration: "45:30",
      description:
        "A comprehensive video lecture introducing fundamental algorithm concepts, complexity analysis, and common algorithmic patterns.",
    ...
    },
    {
      ...
      size: "1.8 MB",
      description:
        "Complete solutions to problem sets covering linear transformations, eigenvalues, and matrix operations.",
    ...
    },
    {
      ...
      duration: "1:20:15",
      description:
        "A comprehensive tutorial series on database design principles, normalization, and best practices.",
    ...
    },
    {
      ...
      size: "5.2 MB",
      description:
        "Complete lab manual for mechanics experiments including procedures, data collection methods, and analysis techniques.",
    ...
    },
    {
      ...
      size: "3.1 MB",
      description:
        "Extensive collection of calculus practice problems covering limits, derivatives, and integrals with detailed solutions.",
  ...
  const renderResourceCard = (resource: (typeof resources)[0]) => {
    ...
    return (
      <Card
        key={resource.id}
        className="hover:shadow-lg transition-all hover:border-purple-300"
      >
        <CardHeader>
          <div className="flex items-start justify-between">
            <div className="flex-1">
              <div className="flex items-center gap-2 mb-2">
                <Icon
                  className={`h-5 w-5 ${
                    isVideo ? "text-pink-600" : "text-purple-600"
                  }`}
                />
