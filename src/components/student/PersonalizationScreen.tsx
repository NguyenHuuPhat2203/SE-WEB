...
export function PersonalizationScreen({ isTutor }: { isTutor?: boolean } = {}) {
  ...
  const t = {
    ...
    analyze:
      language === "en" ? "Analyze my data" : "Phân tích dữ liệu của tôi",
  ...
  const mockTasks = [
    {
      id: 1,
      task: "Review Algorithm Analysis chapter 3",
      priority: "high",
      due: "2 days",
    },
    {
    ...
    {
      id: 3,
      task: "Prepare for Database midterm",
      priority: "medium",
      due: "1 week",
    },
  ];
  ...
  const mockDeadlines = [
    ...
    {
      id: 2,
      title: "Data Structures Project Submission",
      date: "Dec 25, 2025",
    },
      ...
      <Tabs defaultValue="plan" className="space-y-6">
        <TabsList>
          <TabsTrigger value="plan">
            {language === "en" ? "Personalized Plan" : "Kế hoạch cá nhân hóa"}
          </TabsTrigger>
          <TabsTrigger value="analytics">
            {language === "en" ? "Analytics" : "Phân tích"}
          </TabsTrigger>
        </TabsList>
