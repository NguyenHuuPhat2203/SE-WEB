...
const mockResourceDetails: Record<
  number,
  {
    id: number;
    title: string;
...
> = {
  1: {
    ...
    content:
      "This document contains detailed notes from weeks 1-5 of the Data Structures course...",
...
export function ResourceDetailScreen({
  ...
  const resource =
    mockResourceDetails[resourceId as keyof typeof mockResourceDetails];
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 pt-4 border-t">
            ...
            <div>
              <p className="text-sm text-gray-600 mb-1">
                {isVideo ? t.duration : t.size}
              </p>
              <div className="flex items-center gap-1">
                <Clock className="h-4 w-4 text-gray-400" />
                <p className="font-medium">
                  {isVideo ? resource.duration : resource.size}
                </p>
              </div>
            </div>
          </div>
