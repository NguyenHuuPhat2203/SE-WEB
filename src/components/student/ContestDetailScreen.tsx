...
const mockContestDetails = {
  1: {
    ...
    type: "academic",
    description:
      "Competitive programming contest focusing on algorithms and data structures",
    fullDescription:
      "Join us for the most exciting programming competition of the year! Test your skills in algorithmic problem-solving, compete with the best students from HCMUT, and win amazing prizes. This contest covers topics including sorting algorithms, graph theory, dynamic programming, and more.",
    ...
    contacts: [
      {
        name: "Dr. Tran Tuan Anh",
        role: "Contest Coordinator",
        email: "anh.trantuan@hcmut.edu.vn",
      },
      {
        name: "Algorithm Lab",
        role: "Support Team",
        email: "algo.lab@hcmut.edu.vn",
      },
    ],
  },
  2: {
    ...
    fullDescription:
      "A 48-hour hackathon challenge where teams develop innovative tech solutions to improve urban living. Focus areas include transportation, energy efficiency, waste management, and citizen services.",
  ...
  3: {
    ...
    fullDescription:
      "Showcase your data science and machine learning skills in this comprehensive competition. Participants will work with real-world datasets to build predictive models and extract meaningful insights.",
    ...
    contacts: [
      {
        ...
        email: "sach.lethanh@hcmut.edu.vn",
      },
    ],
  },
};
...
export function ContestDetailScreen({
  ...
  const contest =
    mockContestDetails[contestId as keyof typeof mockContestDetails];
            ...
            <CardContent>
              <div className="space-y-4">
                {contest.prizes.map((prize, idx) => (
                  <div
                    key={idx}
                    className="flex items-center gap-4 p-4 bg-gradient-to-r from-purple-50 to-indigo-50 rounded-lg border border-purple-200"
                  >
