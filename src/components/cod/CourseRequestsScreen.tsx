...
export function CourseRequestsScreen() {
  ...
  const t = {
    ...
    description:
      language === "en"
        ...
        : "Xem xét và quản lý yêu cầu môn học của sinh viên",
    ...
    approveSuccess:
      language === "en"
        ...
        : "Đã duyệt yêu cầu!",
    rejectSuccess:
      language === "en" ? "Request rejected!" : "Đã từ chối yêu cầu!",
    totalRequests: language === "en" ? "Total requests" : "Tổng yêu cầu",
    pendingRequests:
      language === "en" ? "Pending requests" : "Yêu cầu chờ duyệt",
    approvedRequests:
      language === "en" ? "Approved requests" : "Yêu cầu đã duyệt",
  };
