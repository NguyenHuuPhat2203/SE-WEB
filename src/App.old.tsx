...
export default function App() {
  ...
  const [selectedConsultationSessionId, setSelectedConsultationSessionId] =
    useState<number>(1);
    ...
    try {
      ...
      if (res.ok) {
        ...
        if (result.success && result.data.length > 0) {
          // Token is valid, could restore user session
  ...
  const renderContent = () => {
    ...
    if (currentScreen === "register") {
      return (
        <RegisterScreen onNavigate={setCurrentScreen} language={language} />
      );
    }
        ...
        case "course-detail":
          return (
            <CourseDetailScreen
              ...
              onBack={() => setCurrentScreen("request-courses")}
            />
          );
        case "resources":
          return (
        ...
        case "tutor-detail":
          return (
            <TutorDetailScreen
              ...
              onBack={() => setCurrentScreen("find-tutor")}
            />
          );
        case "contest-detail":
          return (
